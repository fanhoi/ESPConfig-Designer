    ...
    <div class="module-card__body">
      <div class="module-tabs">
        <button
          ...
          @click="emit('update:activeOtherKey', tab.key)"
        >
          {{ tab.label }}
        </button>
      </div>
      <SchemaRenderer
        ...
        @update="emit('update-other-detail', $event)"
...
defineProps({
  ...
  otherTabs: { type: Array, default: () => [] },
  activeOtherKey: { type: String, default: "" },
  otherDetailId: { type: String, default: "" },
  otherDetailConfig: { type: Object, default: () => ({}) },
  otherDetailScopeId: { type: String, required: true },
